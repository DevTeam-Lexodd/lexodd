...
class _EmployeesTabState extends State<EmployeesTab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('Team ($_total)'), automaticallyImplyLeading: false),
  ...
  Widget _employeeCard(Employee emp, int index) {
    return GestureDetector(
        onTap: () => Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => ProfileScreen(employeeId: emp.id))),
        child: Container(
              ...
              Expanded(
                  child: Column(
                    ...
                    Wrap(spacing: 6, runSpacing: 4, children: [
                      _tag(emp.department, AppTheme.infoColor),
                      _tag(emp.employmentType, AppTheme.successColor),
                    ]),
                  ])),
