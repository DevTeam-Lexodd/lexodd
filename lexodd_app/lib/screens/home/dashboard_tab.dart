...
class _DashboardTabState extends State<DashboardTab> {
  ...
  Widget _buildCarousel() {
    return Column(children: [
      ...
      Row(
          ...
          children: AppConstants.carouselItems
              .asMap()
              .entries
              .map((e) => AnimatedContainer(
                  duration: const Duration(milliseconds: 300),
                  width: _carouselIndex == e.key ? 24 : 8,
                  height: 8,
                  margin: const EdgeInsets.symmetric(horizontal: 3),
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(4),
                      color: _carouselIndex == e.key
        ...
        child: GridView.count(
            ...
            children: [
              StatCard(
                  ...
                  value: '${_data?.totalEmployees ?? 0}',
                  color: AppTheme.primaryColor),
              StatCard(
                  icon: Iconsax.timer_1,
                  title: 'Pending Leaves',
                  value: '${_data?.pendingLeaves ?? 0}',
  ...
  Widget _buildLeaveBalance(dynamic balance) {
    final leaves = [
      ...
      {
        'name': 'Earned',
        'count': balance.earned,
        'color': const Color(0xFF10B981)
      },
      {
        'name': 'Comp Off',
        'count': balance.compOff,
        'color': const Color(0xFFF59E0B)
      },
    ];
    return Padding(
                ...
                children: leaves
                    .map((l) => Column(children: [
                          Container(
                              ...
                              height: 48,
                              decoration: BoxDecoration(
                                  color: (l['color'] as Color).withOpacity(0.1),
    ...
    return Padding(
        ...
        child: Container(
          ...
          child: ListView.separated(
              ...
              itemCount: _data!.recentJoinees.length,
